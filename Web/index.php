...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>Selamat Datang di SMART PJU !</title>
...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          <!-- Sidebar - Brand -->
          <h4 class="sidebar-brand d-flex align-items-center justify-content-center">
            ...
            <div class="sidebar-brand-text mx-2">SMART PJU</div>
          </h4>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
                <a href="login.php">
                  <i class="fas fa-sign-in-alt text-gray-400"> Login</i>
                </a>
            </li>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Monitoring Maps</h1>
          ...
          <div class="row">
            ...
            <div class="col-xl-12 col-lg-7">
              <div class="card shadow mb-4">
                                ...
                                $no=1;
                                  if ($result) {
                                    while($show=mysqli_fetch_array($result)) {
                                      ...
                                      $ambilNama = mysqli_query($conn, "SELECT * FROM lampu_jalan WHERE id_lampu = '$id'");
                                      $namaLampu = mysqli_fetch_array($ambilNama);
                                        $nama    = $namaLampu['nama'];
                ...
                <!-- </div> -->
                <div id="load-google" action="maps-masyarakat.php">
                ...
                ['<div class="info_content" style="text-align:justified">' +
                    ...
                    '<table>'+
                        ...
                        '<table>'+
                            ...
                            // KOTA Lampu
                            '<tr>'+
                                '<td style="font-weight: bold;font-size: 20px;">Kota/Kab</td>'+
                                '<td style="font-weight: bold;font-size: 20px;"> : </td>'+
                                '<td style="font-size: 15px;"><?php echo $row['kota']; ?></td>'+
                            '</tr>'+
                            '<tr>'+
                                '<td><br></td>'+
                            '</tr>'+
  ...
  <script type="text/javascript">
    var auto_refresh = setInterval(
      function () {
        $('#load-google').load('maps-masyarakat.php?id=<?php echo $id ?>').fadeIn("slow");
      }
